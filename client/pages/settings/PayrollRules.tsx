...
export default function PayrollRules() {
  ...
  const [config, setConfig] = useState<PayrollConfiguration>({
    ...
    latePenaltyRate: 0.5,
    absenteeismPolicy:
      "Deduct full day salary for unauthorized absence. Three consecutive days of absence without notice will result in disciplinary action.",
  ...
  const [customRules, setCustomRules] = useState<PayrollRule[]>([
    {
      ...
      description:
        "Calculate transport allowance based on distance from office",
      ruleType: "formula",
      value: "distance * 50",
      isActive: true,
      ...
      priority: 1,
      formula:
        "IF(distance <= 10, distance * 50, IF(distance <= 25, 500 + (distance - 10) * 30, 950 + (distance - 25) * 20))",
  ...
  const exportRules = () => {
    const dataStr = JSON.stringify(
      { configuration: config, customRules },
      null,
      2,
    );
    const dataUri =
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Configure payroll calculation rules and policies
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setConfig({ ...config, salaryFrequency: value as any })
                    }
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        setConfig({ ...config, autoCalculateOvertime: checked })
                      }
                      disabled={!canManageRules}
                    />
                  </div>
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Allow net pay to be negative
                      </p>
                    </div>
                    <Switch
                      checked={config.allowNegativeNet}
                      onCheckedChange={(checked) =>
                        setConfig({ ...config, allowNegativeNet: checked })
                      }
                      disabled={!canManageRules}
                    />
                  </div>
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Ensure all salaries meet minimum wage
                      </p>
                    </div>
                    <Switch
                      checked={config.enforceMinimumWage}
                      onCheckedChange={(checked) =>
                        setConfig({ ...config, enforceMinimumWage: checked })
                      }
                      disabled={!canManageRules}
                    />
                  </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setConfig({
                          ...config,
                          normalHoursRate: Number(e.target.value),
                        })
                      }
                      disabled={!canManageRules}
                    />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setConfig({
                          ...config,
                          weekendHoursRate: Number(e.target.value),
                        })
                      }
                      disabled={!canManageRules}
                    />
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="publicHolidayRate">
                      Public Holiday Rate
                    </Label>
                    <Input
                      ...
                      onChange={(e) =>
                        setConfig({
                          ...config,
                          publicHolidayRate: Number(e.target.value),
                        })
                      }
                      disabled={!canManageRules}
                    />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setConfig({
                          ...config,
                          nightShiftRate: Number(e.target.value),
                        })
                      }
                      disabled={!canManageRules}
                    />
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setConfig({ ...config, earningsRounding: value as any })
                      }
                      disabled={!canManageRules}
                    >
                      <SelectTrigger>
                  ...
                  <div>
                    <Label htmlFor="deductionsRounding">
                      Deductions Rounding
                    </Label>
                    <Select
                      ...
                      onValueChange={(value) =>
                        setConfig({
                          ...config,
                          deductionsRounding: value as any,
                        })
                      }
                      disabled={!canManageRules}
                    >
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setConfig({
                        ...config,
                        absenteeismPolicy: e.target.value,
                      })
                    }
                    disabled={!canManageRules}
                    rows={4}
                ...
                <TableBody>
                  {payrollCalendar.map((period) => (
                    <TableRow key={period.id}>
                      ...
                      <TableCell>
                        {period.isProcessed
                          ? formatKES(period.totalGrossPay)
                          : "-"}
                      </TableCell>
                      <TableCell>
                        {period.isProcessed
                          ? formatKES(period.totalNetPay)
                          : "-"}
                      </TableCell>
                      <TableCell>
