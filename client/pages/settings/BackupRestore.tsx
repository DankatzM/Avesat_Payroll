...
export default function BackupRestore() {
  ...
  const restoreBackup = async (backupId: string) => {
    ...
    if (
      confirm(
        `Are you sure you want to restore from ${backup.name}? This will overwrite all current data and cannot be undone.`,
      )
    ) {
      setIsRestoring(true);
      try {
  ...
  const totalBackupSize = backupFiles.reduce(
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Manage data backups and system restore operations
          </p>
        </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <Alert>
              ...
              <AlertDescription>
                Create an immediate backup of your current data. This is
                recommended before making major changes to the system.
              </AlertDescription>
            </Alert>
            ...
            <div className="space-y-2 text-sm text-gray-600">
              <div className="flex justify-between">
                ...
                <span>
                  {new Date(
                    backupFiles.find((b) => b.type === "automatic")
                      ?.createdAt || "",
                  ).toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between">
                ...
                <span>
                  {new Date(
                    backupFiles.find((b) => b.type === "manual")?.createdAt ||
                      "",
                  ).toLocaleString()}
                </span>
              </div>
      ...
      <Alert variant="destructive">
        <AlertTriangle className="h-4 w-4" />
        <AlertDescription>
          <strong>Warning:</strong> Restore operations will overwrite all
          current data. Always create a backup before restoring from another
